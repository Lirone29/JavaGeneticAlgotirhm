...
public class Genetic {
    ...
    //Change for time of generations
    ...
    public Genome rouletteSelection(List<Genome> _population){
        ...
        int sumOfFitnessValue = _population.stream().map(Genome::getFitness).mapToInt(Integer::intValue).sum();
    ...
    public List<Genome> crossover(List<Genome> _parents){
        ...
        parent1Genome = _parents.get(0).getGenome(); // reseting the edited parent
